...
import PersonIcon from '@mui/icons-material/Person';
import { useTranslation } from 'react-i18next';
import UserCvViewer from './UserCvViewer';
    ...
    return (
        <Container maxWidth="lg" sx={{ mt: 4 }}>
                        ...
                        <GradientCard>
                            <CardContent>
                                ...
                                <Button
                                    variant="contained"
                                    color="primary"
                                    onClick={() => handleViewCv(intern.id)}
                                    sx={{ mt: 2 }}
                                >
                                    {t('view_cv')}
                                </Button>
            ...
            <Modal
                ...
                aria-describedby="view-cv-modal-description"
            >
                <Box sx={{
                    position: 'absolute',
                    top: '50%',
                    ...
                    {selectedInternId && <UserCvViewer userId={selectedInternId} />}
                </Box>
            </Modal>
        </Container>
    );
